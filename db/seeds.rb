...
track19 = Track.create!(title: 'One Summer Day', uploader_id: user12.id, genre: 'anime/games') # cathy
...
track1.track_file.attach(io: track1_track, filename: 'aruarian-dance.mp3')
...
track2.track_file.attach(io: track2_track, filename: 'to-zanarkand.mp3')
...
track3.track_file.attach(io: track3_track, filename: 'stay.mp3')
...
track4.track_file.attach(io: track4_track, filename: 'afternoon.mp3')
...
track5.track_file.attach(io: track5_track, filename: 'sleepwalking.mp3')
...
track6.track_file.attach(io: track6_track, filename: 'pachuca-sunrise.mp3')
...
track7.track_file.attach(io: track7_track, filename: 'shiki-no-uta.mp3')
...
track8.track_file.attach(io: track8_track, filename: 'battlecry.mp3')
...
track9.track_file.attach(io: track9_track, filename: 'rocks-hound-dog.mp3')
...
track10.track_file.attach(io: track10_track, filename: 'pokemon-trainer-red-theme.mp3')
...
track11.track_file.attach(io: track11_track, filename: 'wedding-dress.mp3')
...
track12.track_file.attach(io: track12_track, filename: 'me-n-u-cassie.mp3')
...
track13.track_file.attach(io: track13_track, filename: 'run-it.mp3')
...
track14.track_file.attach(io: track14_track, filename: 'shingeki-no-kyojin-aot.mp3')
...
track15.track_file.attach(io: track15_track, filename: 'the-world-is-ours.mp3')
...
track16.track_file.attach(io: track16_track, filename: 'youth-manila-killa.mp3')
...
track17.track_file.attach(io: track17_track, filename: 'asterisk.mp3')
...
track18.track_file.attach(io: track18_track, filename: 'trying-to-be-cool.mp3')
...
track19.track_file.attach(io: track19_track, filename: 'one-summer-day.mp3')
...
track20.track_file.attach(io: track20_track, filename: 'ellinia.mp3')
...
track21.track_file.attach(io: track21_track, filename: 'roses.mp3')
...
track22.track_file.attach(io: track22_track, filename: 'lisztomania.mp3')
...
track23.track_file.attach(io: track23_track, filename: 'out-of-my-league.mp3')
...
track24.track_file.attach(io: track24_track, filename: 'waves.mp3')
...
track25.track_file.attach(io: track25_track, filename: 'your-ex-lover-is-dead.mp3')
...
track26.track_file.attach(io: track26_track, filename: 'fools-gold.mp3')
...
track27.track_file.attach(io: track27_track, filename: 'simple-and-clean.mp3')
...
track28.track_file.attach(io: track28_track, filename: 'catching-on.mp3')
...
track29.track_file.attach(io: track29_track, filename: 'aint-it-fun.mp3')
...
track30.track_file.attach(io: track30_track, filename: 'go-with-it.mp3')
